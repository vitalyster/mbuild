...
cp "${MSYS_SRCDIR}"/{guess-msvc.bat,start-msvc71.bat,start-msvc8.bat,start-msvc9.bat,start-msvc10.bat,start-msvc11.bat,start-l10n.bat,start-msvc8-x64.bat,start-msvc9-x64.bat,start-msvc10-x64.bat,start-msvc11-x64.bat} "${MSYS_STAGEDIR}/mozilla-build"
