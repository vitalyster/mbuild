...
# Update the copy of SQLite bundled with Python to version 3.11.1
unzip -d "${MSYS_STAGEDIR}/mozilla-build/python/DLLs" -o "${MSYS_SRCDIR}/sqlite-dll-win32-x86-3110100.zip"
