...
if test -n "$MOZILLABUILD"; then
    ...
    PATH="/local/bin:$MSYS_MOZBUILD/wget:$MSYS_MOZBUILD/7zip:$MSYS_MOZBUILD/blat261/full:$MSYS_MOZBUILD/python:$MSYS_MOZBUILD/svn-win32-1.6.3/bin:$MSYS_MOZBUILD/upx203w:$MSYS_MOZBUILD/emacs-24.3/bin:$MSYS_MOZBUILD/info-zip:$MSYS_MOZBUILD/nsis-2.46u:$MSYS_MOZBUILD/nsis-3.0a2:$MSYS_MOZBUILD/wix-351728:$MSYS_MOZBUILD/hg:$MSYS_MOZBUILD/python/Scripts:$MSYS_MOZBUILD/kdiff3:$MSYS_MOZBUILD/yasm:$MSYS_MOZBUILD/mozmake:$PATH:$MSYS_MOZBUILD/vim/vim72"
    EDITOR="emacs.exe"
    CVS_RSH=ssh
